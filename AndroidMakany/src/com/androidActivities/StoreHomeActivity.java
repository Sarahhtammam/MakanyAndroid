...
public class StoreHomeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!Application.loggedIn) {
			...
			Toast.makeText(getApplicationContext(), "first visit to homepage",
					Toast.LENGTH_LONG).show();
		...
		editOffer.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				/*
				 * Intent eventsIntent = new
				 * Intent(getApplicationContext(),editOfferActivity.class);
				 * startActivity(eventsIntent);
				 */
		...
		removeOffer.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				/*
				 * Intent eventsIntent = new
				 * Intent(getApplicationContext(),removeOfferActivity.class);
				 * startActivity(eventsIntent);
				 */
