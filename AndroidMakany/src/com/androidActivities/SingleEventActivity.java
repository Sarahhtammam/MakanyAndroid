...
public class SingleEventActivity extends MyDrawerMenu implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// eventController.joinEvent(currentEvent.getID() ,
		// Application.getCurrentEmail());
	...
	public void onClick(View v) {
		...
		if (id == R.id.reviewEvent) {
			...
			alert.setPositiveButton("Add Review",
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
							String reviewText = userEventReview.getText()
									.toString();
							String ratingText = userEventRating.getText()
									.toString();

							EventController eventController = new EventController();
							eventController.reviewEvent(
									Application.getUserEmail(),
									currentEvent.getID(), reviewText,
									ratingText);
						}
					});
		...
		if (id == R.id.postOnEvent) {
			...
			alert.setPositiveButton("Add Post",
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
			...
			alert.setNegativeButton("Cancel",
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
							Toast.makeText(Application.getAppContext(),
									"Your post is cancelled", Toast.LENGTH_LONG)
									.show();
						}
					});
		...
		if (id == R.id.DisAttendEvent) {
			EventController eventController = new EventController();
			eventController.cancelGoingEvent(currentEvent.getID(),
					Application.getUserEmail());
